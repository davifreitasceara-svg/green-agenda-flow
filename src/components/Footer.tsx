      ...
      <div className="mx-auto max-w-7xl px-6 relative z-10 bg-black pb-16">
        ...
        <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="flex flex-col gap-6">
            <a href="https://wa.me/558589059679" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 bg-white/5 p-4 rounded-xl shadow-sm hover:bg-white/10 transition-colors border border-white/10 w-max">
