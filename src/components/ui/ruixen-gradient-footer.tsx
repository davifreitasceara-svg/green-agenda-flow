...
// Custom Green/White/Black stops
const CUSTOM_STOPS: Stop[] = [
  { offset: 0, color: "#000000" },      // Black
  { offset: 0.3, color: "#004d30" },    // Dark Green
  { offset: 0.6, color: "#007F4F" },    // Primary Green
  { offset: 0.8, color: "#FFFFFF" },    // White
  { offset: 1, color: "#ffffff00" },    // Transparent
];
...
export function RuixenGradientFooter({
  ...
  return (
    ...
    >
      ...
      >
        <svg
          style={{ height: "100%", width: "100%", display: "block", opacity: 0.8 }}
          viewBox={`0 0 ${VBW} ${VBH}`}
